...
/* A sample structure to pass events from the timer interrupt handler to the main program. */
...
{   
    ...
    printf("\n\nSTO INIZIALIZZANDO IL TIMER_%d\n\n", timer_idx);
...
void app_main()
{
    ...
    tg0_timer_init(TIMER_1, TEST_WITH_RELOAD, TIMER_INTERVAL0_SEC);                         //Set 5s (int0) for testing
    tg0_timer_init(TIMER_0, TEST_WITHOUT_RELOAD, TIMER_INTERVAL1_SEC);                      //Set 10s (int1) for testing
